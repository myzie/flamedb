...
func (o *UpdateRecordURL) Build() (*url.URL, error) {
	...
	if recordID != "" {
		...
		return nil, errors.New("RecordID is required on UpdateRecordURL")
	}
...
func (o *UpdateRecordURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateRecordURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateRecordURL")
	}
