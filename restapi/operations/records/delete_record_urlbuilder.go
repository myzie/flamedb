...
func (o *DeleteRecordURL) Build() (*url.URL, error) {
	...
	if recordID != "" {
		...
		return nil, errors.New("RecordID is required on DeleteRecordURL")
	}
...
func (o *DeleteRecordURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteRecordURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteRecordURL")
	}
