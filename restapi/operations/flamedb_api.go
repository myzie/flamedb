...
type FlamedbAPI struct {
	...
	// RecordsCreateRecordHandler sets the operation handler for the create record operation
	...
	RecordsListRecordsHandler records.ListRecordsHandler
	// RecordsUpdateRecordHandler sets the operation handler for the update record operation
	RecordsUpdateRecordHandler records.UpdateRecordHandler
...
func (o *FlamedbAPI) Validate() error {
	...
	if o.RecordsCreateRecordHandler == nil {
		unregistered = append(unregistered, "records.CreateRecordHandler")
	}
	...
	if o.RecordsGetRecordHandler == nil {
		unregistered = append(unregistered, "records.GetRecordHandler")
	}

	if o.RecordsListRecordsHandler == nil {
		unregistered = append(unregistered, "records.ListRecordsHandler")
	}

	if o.RecordsUpdateRecordHandler == nil {
		unregistered = append(unregistered, "records.UpdateRecordHandler")
	}
...
func (o *FlamedbAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/records"] = records.NewCreateRecord(o.context, o.RecordsCreateRecordHandler)
	...
	o.handlers["GET"]["/records/{recordId}"] = records.NewGetRecord(o.context, o.RecordsGetRecordHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/records"] = records.NewListRecords(o.context, o.RecordsListRecordsHandler)

	if o.handlers["PUT"] == nil {
		o.handlers["PUT"] = make(map[string]http.Handler)
	}
	o.handlers["PUT"]["/records/{recordId}"] = records.NewUpdateRecord(o.context, o.RecordsUpdateRecordHandler)
